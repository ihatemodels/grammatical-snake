...
def scraper():
    ''' One time run script to scrape dictionary.calipers.bg 
        for marketing and internet based termins and definition.
    ...
    req = requests.get('http://dictionary.calipers.bg/bg/%D0%B2%D1%81%D0%B8%D1%87%D0%BA%D0%B8-%D0%B4%D1%83%D0%BC%D0%B8/')
